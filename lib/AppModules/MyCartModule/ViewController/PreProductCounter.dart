...
class PreProductCounter extends StatefulWidget {
  Function callBack;
  ...
  @override
  State<PreProductCounter> createState() => _PreProductCounterState();
}

// ignore: camel_case_types
class _PreProductCounterState extends State<PreProductCounter> {
        ...
        children: [
          ...
          IconButton(
            onPressed: () {
              ...
              // setState(() {});
              if (quantit < int.parse(widget.totalGuantity)) quantit++;
              print("QUANTIT ++");
              print(quantit);
              print(oldQuantity);
              widget.callBack(quantit, oldQuantity);
