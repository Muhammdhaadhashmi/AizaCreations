...
class ViewGeneralProduct extends StatefulWidget {
  dynamic productdata;
  bool isPrebooking;
  bool isMyPrebooking;
  ...
  @override
  _ViewGeneralProductState createState() => _ViewGeneralProductState();
}

class _ViewGeneralProductState extends State<ViewGeneralProduct> {
                      ...
                      child: Container(
                        ...
                        child: ListView(
                          ...
                          children: [
                            ...
                            myText(
                                title:
                                    "${widget.productdata["pro_discription"]}",
                                color: Colors.black45,
